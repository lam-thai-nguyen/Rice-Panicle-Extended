...
def main():
    # Data
    x_value = [30, 34, 38, 42, 46]  # bbox sizes
    f1_train = [0.885654136, 0.873199409, 0.885158937, 0.885753198, 0.874609593]
    f1_val = [0.87767041, 0.868022729, 0.878959137, 0.877188585, 0.870006221]
    pr_train = [0.925876763, 0.917608235, 0.919313418, 0.898887701, 0.89702623]
    pr_val = [0.916948804, 0.910569498, 0.91223084, 0.891140726, 0.889470199]
    rc_train = [0.85224992, 0.837028454, 0.856909858, 0.876318292, 0.856955465]
    rc_val = [0.846011246, 0.834329451, 0.852670462, 0.867533261, 0.854864273]
