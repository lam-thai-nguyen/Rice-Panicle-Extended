...
def update_ricepr(PATH, update):
    ...
    assert num_vertices == len(vertices.findall('vertex')), "At least 2 clicked points have the same nearest neighbor. Thus, fewer vertices than specified were removed. Try again if needed."
